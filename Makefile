...
I_RABBITMQ_PORT      := 5672
I_RABBITMQ_MGMT_PORT := 15672
I_GATEWAY_PORT       := 8080
...
H_RABBITMQ_PORT      := 5672
H_RABBITMQ_MGMT_PORT := 15672
H_GATEWAY_PORT       ?= 8080
...
env:
	...
	echo "RABBITMQ_HOST_PORT=$(H_RABBITMQ_PORT)"; \
	...
	echo "RABBITMQ_INTERNAL_PORT=$(I_RABBITMQ_PORT)"; \
	echo "RABBITMQ_MANAGEMENT_INTERNAL_PORT=$(I_RABBITMQ_MGMT_PORT)"; \
	echo "RABBITMQ_USER=admin"; \
	echo "RABBITMQ_PASSWORD=admin"; \
