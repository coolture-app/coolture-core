    ...
    public class CommentService {
        ...
        public CursorPage<CommentSummaryDto> list(UUID postId, UUID parentCommentId,
            ...
            List<CommentSummaryDto> dtos = rows.stream()
                    .map(c -> commentMapper.toDto(c, avatars.get(c.getAuthor().getId())))
                    .toList();
        ...
        public CommentSummaryDto create(UUID postId, UUID callerId, CommentCreateRequest request) {
            ...
            return commentMapper.toDto(
                    comment,
                    userAvatarService.resolveThumbnail(comment.getAuthor().getId()));
        }
